...
Replace `PaperTrailBackend.gs` with `gas/PaperTrailBackend.gs`. The GAS parent page is generated by `buildPaperTrailHtml_()`, so no HTML file needs to be synchronized.
